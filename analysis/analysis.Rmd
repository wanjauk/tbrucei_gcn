...
write.table(result, file="../results/genes_results_df.txt", quote = FALSE, sep = "\t")

write.xlsx(result, file="../results/genes_results_df.xlsx")
...
module_hub_genes_domain_description <- module_hub_genes_domain_description %>%
  dplyr::rename(hub_genes=module.hub.genes)

write.xlsx(module_hub_genes_domain_description,
           file = "../results/module_hub_genes_domain_description.xlsx",
           #append = TRUE,
           row.names = FALSE)
...
cut -f1 -d ":" ../data/tbrucei_annotated_transcripts/TriTrypDB-43_TbruceiTREU927_AnnotatedTranscripts.fasta > \
../results/tbrucei_annotated_transcript_sequences.fasta
