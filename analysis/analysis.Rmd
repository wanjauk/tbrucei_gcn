...
# DE genes in the PV that are common to both comparisons
...
vennDiagram(PV_vs_MG_de.genes==1, SG_vs_PV_de.genes==1, circle.col=c("turquoise", "salmon"))
```
...
png(filename = "../figures/gene_tree&TOM.png", res =1200, type = "cairo", units = 'in',
...
png(filename = "../figures/gene_tree&colours.png", res =1200, type = "cairo", units = 'in',
    width = 5, height = 6, pointsize = 10)
