...
png(filename = "../figures/norm.filt_sample_heatmap.png", res =1200, type = "cairo", units = 'in',
...
#pdf(file = "../figures/norm.filt_sample_density.pdf")
png("../figures/norm.filt_sample_density.png", res =1200, type = "cairo", units = 'in',
...
#pdf(file = "../figures/norm.filt_sample_boxplot.pdf")
png(filename = "../figures/norm.filt_sample_boxplot.png", res =1200, type = "cairo", units = 'in',
    width = 6, height = 4, pointsize = 6)
