...
table(rowSums(counts$counts==0)==17)
# FALSE  TRUE 
# 10060  1772
...
png(filename = "../figures/norm.filt_sample_PCA.png", res =1200, type = "cairo", units = 'in',
    width = 6, height = 4, pointsize = 10)
...
#par(mar=c(6,3,1,1))
#boxplot(logcpm.norm.counts, las=2)
...
#network.counts <- network.counts * 1.0 # convert to float; necessary for cor function. (Inbar et al)
