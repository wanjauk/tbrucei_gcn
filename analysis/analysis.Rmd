...
write.xlsx(result, file="../results/genes_results_df.xlsx", sheetName="Gene Clustering")
...
go_enrichment_df_list <- c("black","tan","brown","blue","turquoise","magenta","darkturquoise",
  ...
  for(name in enrichment_df_list){
...
go_enrichment_df_list <- c("blue","magenta","red","pink","lightyellow","yellow","lightcyan")
