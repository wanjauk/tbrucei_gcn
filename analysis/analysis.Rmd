...
For further analysis, samples read counts are read into R. To read the sample counta data into R using the script below, simply type `source("../scripts/htseq-combine_all.R") ` in the R console and hit enter.
...
png(filename = "../figures/filtered_sample_heatmap.png", res = 90, type = "cairo")

heatmap.2(cor(log2(filtered.data.all + 1)), RowSideColors=sample.colours, trace='none', main='Sample correlations')
...
png("../figures/filtered_sample_density.png", res = 90, type = "cairo")
...
png(filename = "../figures/filtered_sample_PCA.png", res = 90, type = "cairo")
 ...
 **Boxplot**
```{r, eval=FALSE}
png(filename = "../figures/filtered_sample_boxplot.png", res =90, type = "cairo")
boxplot(log.counts)
dev.off()
```
