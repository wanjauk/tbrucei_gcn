...
# get common DE genes between PV-MG and PV-SG
MG_PV_common <- subset(PV_data, PV_vs_MG_de.genes!=0 & SG_vs_PV_de.genes!=0)
PV_SG_common <- subset(SG_data, PV_vs_MG_de.genes!=0 & SG_vs_PV_de.genes!=0)

MG_PV_common <- MG_PV_common[order(MG_PV_common$logFC, decreasing = TRUE),]
PV_SG_common <- PV_SG_common[order(PV_SG_common$logFC, decreasing = TRUE),]
...
write.xlsx(PV_vs_MG, file = "../results/Significant_differentially_expressed_genes.xlsx",
           sheetName = "Midgut vs Proventriculus DE genes")
write.xlsx(SG_vs_PV, file = "../results/Significant_differentially_expressed_genes.xlsx",
           sheetName = "Proventriculus vs Salivary glands DE genes", append = TRUE)
write.xlsx(MG_PV_common, file = "../results/Significant_differentially_expressed_genes.xlsx",
           sheetName = "Midgut vs Proventriculus Common genes", append = TRUE)
write.xlsx(PV_SG_common, file = "../results/Significant_differentially_expressed_genes.xlsx",
           sheetName = "Proventriculus vs Salivary glands Common genes", append = TRUE)
```
...
# A list of module hub genes
                black                  blue                 brown 
  "Tb927.7.1790:mRNA"   "Tb927.8.3620:mRNA"  "Tb927.11.1570:mRNA" 
                 cyan             darkgreen              darkgrey 
  "Tb927.2.5530:mRNA" "Tb927.11.14020:mRNA"   "Tb927.9.9450:mRNA" 
           darkorange               darkred         darkturquoise 
   "Tb927.8.710:mRNA"   "Tb927.2.5270:mRNA"   "Tb927.8.6650:mRNA" 
                green           greenyellow                grey60 
"Tb927.10.13790:mRNA"    "Tb927.7.920:mRNA"  "Tb927.10.3820:mRNA" 
            lightcyan            lightgreen           lightyellow 
 "Tb927.11.6440:mRNA"   "Tb927.10.720:mRNA"  "Tb927.10.2560:mRNA" 
              magenta          midnightblue                orange 
  "Tb927.9.6290:mRNA"  "Tb927.11.6640:mRNA"   "Tb927.9.2520:mRNA" 
                 pink                purple                   red 
 "Tb927.10.6200:mRNA"    "Tb927.1.600:mRNA"   "Tb927.7.6920:mRNA" 
            royalblue                salmon                   tan 
"Tb927.10.15680:mRNA"  "Tb927.11.1450:mRNA"   "Tb927.3.2930:mRNA" 
            turquoise                 white                yellow 
 "Tb927.9.15630:mRNA"   "Tb927.8.7980:mRNA"   "Tb927.1.3550:mRNA"
...
# a list of merged module hub genes
                black                  blue                 brown 
  "Tb927.7.1790:mRNA"   "Tb927.1.3130:mRNA" "Tb927.11.14220:mRNA" 
             darkgrey               darkred                 green 
  "Tb927.11.760:mRNA"   "Tb927.5.1050:mRNA"   "Tb927.8.6580:mRNA" 
          greenyellow            lightgreen                   red 
"Tb927.11.10610:mRNA"   "Tb927.10.720:mRNA" "Tb927.10.14900:mRNA" 
               salmon                 white                yellow 
 "Tb927.11.1450:mRNA"   "Tb927.8.3530:mRNA"   "Tb927.1.3550:mRNA"
...
write.table(node.attributes, file = "../results/Cytoscape_node_attributes.txt",row.names = FALSE, 
            quote = FALSE, sep = "\t")
...
\newpage
```{r fig.cap="Subnetwork of 1399 genes", echo=FALSE, out.width='80%'}
...
png(filename = "../figures/gene_tree_and_module_enrichment_status.png", res =1200, 
    type = "cairo", units = 'in', width = 5, height = 6, pointsize = 10)
...
\newpage
```{r fig.cap="Gene tree and module enrichment status", echo=FALSE, out.width='80%', eval=FALSE}
