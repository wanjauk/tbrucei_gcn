...
For further analysis, samples read counts are read into R. To read the sample counts data into R using the script below, simply type `source(here::here("scripts","import-read-counts-into-r.R")` on the R console and hit enter.
...
```{r, code = readLines(here::here("scripts","analysis","coexpression-network-construction.R")), eval=FALSE}
...
```{r, code = readLines(here::here("scripts","analysis","FIRE-input.R")), eval=FALSE}
